...
class AppCommonStatusBase extends EnumClass{
    ...
    constructor(status_name, status_message) {
        ...
        const element = AppCommonStatusBase.#keyNames[status_name];
        if(element == null) {
            AppCommonStatusBase.#keyNames[status_name] = this;   
        }
        else {
    ...
    static getStatusByKeyName = (status_name) => {
        return AppCommonStatusBase.#keyNames[status_name];
    }
